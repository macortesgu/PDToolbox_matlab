...
n = 25;%25 % MC. Energía , o potencia? que se distribuye entre los agentes, por cada población.
...
% initial condition
pot = ones(N,T_+1)/(T_+1);%pot = ones(N,T_+1)/(T_+1);
x0 = pot;
