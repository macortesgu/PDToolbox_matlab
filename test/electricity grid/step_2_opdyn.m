...
initial_state = linspace(1,0.2,P);% %zeros(N,1)initial beliefs of users
tMax = 100;%1e3; %Max. iterations for op dynamics
...
theta = ((logspace(2, 3, P)/1000))';%column vector of susceptibility
theta(P) = 0.15;
